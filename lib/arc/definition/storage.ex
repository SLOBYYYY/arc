defmodule Arc.Definition.Storage do
  defmacro __using__(_) do
    quote do
      ...
      def storage_dir(_, _), do: Application.get_env(:arc, :storage_dir, "priv/uploads")
      ...
      defoverridable [request_dir: 2, storage_dir: 2, filename: 2, validate: 1, default_url: 1, default_url: 2, __storage: 0, bucket: 0]
